"""
Django settings for brandify_project project.
...
SECRET_KEY = 'django-insecure-cym-^!#4$*xkyx-$wsmw98m2n!@-!7tegcz&wi#n8^p6ze#d=n'
...
ROOT_URLCONF = 'brandify_project.urls'
...
WSGI_APPLICATION = 'brandify_project.wsgi.application'
